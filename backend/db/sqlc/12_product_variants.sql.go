...
INSERT INTO product_variants (
    ...
    $1, $2, $3, $4, $5, $6, $7
) RETURNING id, product_id, sku, attributes, cost_price, selling_price, stock_level, image_url, archived_at, created_at, updated_at
`
...
SELECT id, product_id, sku, attributes, cost_price, selling_price, stock_level, image_url, archived_at, created_at, updated_at FROM product_variants
WHERE id = $1 LIMIT 1
`
