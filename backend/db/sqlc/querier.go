...
type Querier interface {
	...
	GetInventoryValuation(ctx context.Context, storeID pgtype.UUID) ([]GetInventoryValuationRow, error)
	GetInventoryValuationByCategory(ctx context.Context, storeID pgtype.UUID) ([]GetInventoryValuationByCategoryRow, error)
	GetInventoryValuationSummary(ctx context.Context, storeID pgtype.UUID) (GetInventoryValuationSummaryRow, error)
	GetLowStockProducts(ctx context.Context, storeID pgtype.UUID) ([]Product, error)
	GetLowStockReport(ctx context.Context, storeID pgtype.UUID) ([]GetLowStockReportRow, error)
	...
	GetStockAdjustmentsByProduct(ctx context.Context, arg GetStockAdjustmentsByProductParams) ([]GetStockAdjustmentsByProductRow, error)
	GetStockByCategory(ctx context.Context, storeID pgtype.UUID) ([]GetStockByCategoryRow, error)
	GetStockMovementSummary(ctx context.Context, arg GetStockMovementSummaryParams) (GetStockMovementSummaryRow, error)
	GetStockMovementsByProduct(ctx context.Context, arg GetStockMovementsByProductParams) ([]GetStockMovementsByProductRow, error)
