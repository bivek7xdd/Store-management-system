...
import { Search, Users, RefreshCw, Smartphone, Award, ShoppingBag, ChevronRight, UserMinus } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pb-24 lg:pb-8">
      ...
      <div className="border border-[#1A1A1A] rounded-[2px] bg-[#000000] overflow-hidden">
        <div className="hidden sm:grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 px-6 py-4 bg-[#111111] border-b border-[#1A1A1A]">
        ...
        <div className="divide-y divide-[#1A1A1A]">
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="p-6 grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4">
            ...
            filteredCustomers.map(customer => (
              <div key={customer.id} className="group p-6 grid grid-cols-1 sm:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 items-center hover:bg-[#0A0A0A] transition-colors cursor-default">
