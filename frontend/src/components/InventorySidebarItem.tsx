...
export function InventorySidebarItem({ isActive }: { isActive: boolean }) {
    ...
    const inventoryLinks = [
        ...
        { icon: Search, label: "Find Suppliers", path: "/find-suppliers" },
    ];
            ...
            <AccordionItem value="inventory" className="border-0">
                ...
                >
                    <div className="flex items-center gap-3">
                        <Package className={cn("h-5 w-5", isActive ? "text-primary" : "text-muted-foreground group-hover:text-foreground")} />
                        Inventory
                    </div>
                </AccordionTrigger>
